...
public class UserController {
    ...
    public @ResponseBody
    String updatePassword(String oldpwd, String newpwd, HttpServletRequest request, HttpSession session){
    ...
    public @ResponseBody
    String updateInfo(User user, HttpServletRequest request, HttpSession session){
