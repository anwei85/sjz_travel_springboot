            ...
            <div id="page-wrapper">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <form class="form-inline" action="${pageContext.request.contextPath }/manageFavorites" method="post">
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <c:forEach items="${favorites}" var="favorites">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="${pageContext.request.contextPath }/deleteFavorites?id=${favorites.id}" class="btn btn-danger btn-xs" onclick="return confirm('确定要删除这条收藏记录吗？');">删除</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
